...
export default function LAYOUTGestionale({ children }) {
    ...
    <div className="grid grid-cols-12 grid-rows-12 h-screen w-screen md:p-5 p-1 justify-center items-center bg-neutral-300 dark:bg-neutral-950">
        ...
        <div className="md:col-span-11 col-span-12 md:row-span-11 row-span-10 md:col-start-2 col-start-1 md:row-start-2 row-start-3 h-full bg-neutral-100 dark:bg-neutral-900 md:p-7 p-1">{children}</div>
    </div>
    </>    
    )
}